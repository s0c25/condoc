<x-modal>
  ...
  <x-slot name="content">
    <form method="post" enctype="multipart/form-data" action="{{ route('pdfcreate') }}">
      @csrf
      ...
      <div class="px-4 py-3  text-right sm:px-6">
        <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm
             ...
             focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Ver Reporte</button>
      </div>
      </div>
