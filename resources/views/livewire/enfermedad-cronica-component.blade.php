    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
            <table class="min-w-full leading-normal">
                ...
                <tbody>
                    @forelse ($enfermedadCronicas as $enfermedadCronica)
                                ...
                                <div class="flex items-center">
                                    <div class="ml-3 mx-8">
                                        <p class="text-gray-900 text-xl font-bold whitespace-no-wrap">
                                            {{ $enfermedadCronica->name }}</p>
                                        <span class="relative inline-block px-3 py-1 font-semibold leading-tight mr-50">
                                            @if ($confirming === $enfermedadCronica->id)

                                                <button title="¿Seguro"
                                                    wire:click="destroy({{ $enfermedadCronica->id }})">
                                                    <span aria-hidden
                                            ...
                                            @else
                                                <button title="Eliminar"
                                                    wire:click="confirmDelete({{ $enfermedadCronica->id }})">
                                                    <span aria-hidden
                                                        class="absolute inset-0 bg-red-900 opacity-50 rounded-full"></span>
