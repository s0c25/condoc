<div class="bg-gray-800 rounded-lg">
    <div class="my-2 flex sm:flex-row flex-col pt-5 mx-5">
        <div class="block relative ">
            ...
            <input placeholder="LCD" type="text"
            ...
            <table class="min-w-full leading-normal">
                ...
                <tbody>
                    @forelse ($drogas as $droga)
                        ...
                        <tr>
                            <td class="px-5 py-5 border-b border-red-900 bg-yellow-200 text-sm">
                                ...
                                <div class="flex items-center">
                                    <div class="ml-3 mx-8">
                                        ...
                                        <span class="relative inline-block px-3 py-1 font-semibold leading-tight mr-50">
                                            @if ($confirming === $droga->id)

                                                <button title="¿Seguro" wire:click="destroy({{ $droga->id }})">
                                                    <span aria-hidden
                                            ...
                                            @else
                                                <button title="Eliminar"
                                                    wire:click="confirmDelete({{ $droga->id }})">
                                                    <span aria-hidden
                                                        class="absolute inset-0 bg-red-900 opacity-50 rounded-full"></span>
