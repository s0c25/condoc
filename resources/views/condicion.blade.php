                        ...
                        <ul class="flex">
                            <li @click="openTab = 1" :class="{ '-mb-px': openTab === 1 }" class="-mb-px mr-1">
                                <a :class="openTab === 1 ? activeClasses : inactiveClasses"
                                    class="bg-yellow-300 inline-block py-2 px-4 font-semibold" href="#">
                                    Drogas
                                </a>
                            </li>
                            <li @click="openTab = 2" :class="{ '-mb-px': openTab === 2 }" class="mr-1">
                                <a :class="openTab === 2 ? activeClasses : inactiveClasses"
                                    class="bg-gray-500 inline-block py-2 px-4 font-semibold" href="#">Sustancias
                                    Toxicas
                                </a>
                            </li>
                            <li @click="openTab = 3" :class="{ '-mb-px': openTab === 3 }" class="mr-1">
                                <a :class="openTab === 3 ? activeClasses : inactiveClasses"
                                    class="bg-red-300 inline-block py-2 px-4 font-semibold" href="#">Alcohol/Tabaco
                                </a>
                            </li>
                        </ul>
                        <div id="panels">
                            ...
                            <div class="w-full pt-2">
                                <div x-show="openTab === 1">
                                    @livewire('drogas-component')
                                </div>
                                <div x-show="openTab === 2">
                                    @livewire('toxico-component')
                                </div>
                                <div x-show="openTab === 3">
                                    @livewire('vicios-component')
                                </div>
                            </div>
                        </div>
                    </div>
